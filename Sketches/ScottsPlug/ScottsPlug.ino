...
//******************************************************************************************
String str_ssid     = "Romans";                           //  <---You must edit this line!
String str_password = "ThoseSillyRomans!";                   //  <---You must edit this line!
...
IPAddress hubIp(192, 168, 1, 200);    // smartthings/hubitat hub ip //  <---You must edit this line!
...
void setup()
{
  ...
  //******************************************************************************************
  //Polling/Executor Devices
  
  //Special sensors/executors (uses portions of both polling and executor classes)
  static st::EX_Switch executor1(F("switch1"), PIN_SWITCH, LOW, false);
